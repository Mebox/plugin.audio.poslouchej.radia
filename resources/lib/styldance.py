...
class Main:
    ...
    def start(self, selfGet):
        ...
        list = [
            ...
            ['Puls Radio Lounge (F)', 'https://str2b.openstream.co/1501?aw_0_1st.collectionid=6044&stationId=6044&publisherId=1525&k=1611856916', 'https://i62.servimg.com/u/f62/19/40/01/67/lounfe10.jpg'],
        ...
        def test(self, selfGet):
            ...
            if self.opt2 == '':
                ...
                for element in data['stanice']:
                    ...
                    xbmcplugin.addDirectoryItem(handle=int(sys.argv[1]), url=sys.argv[0] + '?da_' + str(i),
