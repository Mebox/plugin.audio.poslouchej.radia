...
class Main:
    ...
    def start(self, selfGet):
        ...
        list = [
            ...
            [__addon__.getLocalizedString(30012), sys.argv[0] + '?ms', 'genres.png', '',
             getSettingBool('styl_mluvene_slovo')],
            ...
            [__addon__.getLocalizedString(30014), sys.argv[0] + '?sp', 'genres.png', '',
             getSettingBool('styl_solopro')],
            [__addon__.getLocalizedString(30015), sys.argv[0] + '?zp', 'genres.png', '',
             getSettingBool('stylzpravodajsky')],
        ]
