...
class Main:
    ...
    def start(self, selfGet):
        ...
        list = [
            ...
            ['RockMax Rádio Heavy (CZ)', 'http://212.111.2.151:8000/rm_hard_256.mp3', 'https://i62.servimg.com/u/f62/19/40/01/67/radior15.jpg'],
            ['RockMax Rádio Oldies (CZ)', 'http://212.111.2.151:8000/rm_old_256.mp3', 'https://i62.servimg.com/u/f62/19/40/01/67/radior15.jpg'],
            ['RockMax Rádio (CZ)', 'http://212.111.2.151:8000/rockmax_256.mp3', 'https://i62.servimg.com/u/f62/19/40/01/67/radior15.jpg'],
