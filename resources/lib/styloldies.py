...
class Main:
    ...
    def start(self, selfGet):
	    ...
	    ['OpenFM - 80s Hits (PL)', 'http://stream.polskastacja.pl/ps3_mp3', 'https://i46.servimg.com/u/f46/19/40/01/67/c17532.png'],
            ...
            ['RMI - Italo Disco Greatest Hits (PL)', 'https://mpc.mediacp.eu/stream/radiocast', 'https://i46.servimg.com/u/f46/19/40/01/67/c17528.png'],
        ...
        def test(self, selfGet):
            ...
            if self.opt2 == '':
                ...
                for element in data['stanice']:
                    ...
                    xbmcplugin.addDirectoryItem(handle=int(sys.argv[1]), url=sys.argv[0] + '?ol_' + str(i),
