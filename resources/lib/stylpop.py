...
class Main:
    ...
    def start(self, selfGet):
	    ...
	    ['Rádio Merkur (CZ)', 'http://ice4.abradio.cz/merkur-casino128.mp3', 'https://i62.servimg.com/u/f62/19/40/01/67/radiom12.jpg'],
            ['Rádio Pelhřimov (CZ)', 'http://ca9.rcast.net:8054/', 'https://i.servimg.com/u/f46/19/40/01/67/rdio_p10.jpg'],
        ...
        def test(self, selfGet):
            ...
            if self.opt2 == '':
                ...
                for element in data['stanice']:
                    ...
                    xbmcplugin.addDirectoryItem(handle=int(sys.argv[1]), url=sys.argv[0] + '?po_' + str(i),
