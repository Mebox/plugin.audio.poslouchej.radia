...
class Main:
    ...
    def start(self, selfGet):
        ...
        list = [
            ...
            ['Rádio Max (SK)', 'http://mp3stream4.abradio.cz:8000/max128.mp3', 'https://i11.servimg.com/u/f11/19/40/01/67/radiom12.jpg'],
	    ...
	    ['Rádio Blaník (CZ)', 'http://ice.abradio.cz/blanikfm128.mp3?i=86.22812972256186', 'https://i62.servimg.com/u/f62/19/40/01/67/radiob12.jpg'],
            ...
            ['Rádio Bonton (CZ)', 'http://pool.cdn.lagardere.cz/fm-bonton-128', 'https://i62.servimg.com/u/f62/19/40/01/67/radiob13.jpg'],
	    ...
	    ['Hitradio Ö3 (A)', 'https://oe3shoutcast.sf.apa.at/stream/1/', 'https://i46.servimg.com/u/f46/19/40/01/67/c17511.png'],
            ['Life Radio Love (A)', 'http://liferadio.stream.kapper.net:8003/lovelife', 'https://i46.servimg.com/u/f46/19/40/01/67/c17519.png'],
